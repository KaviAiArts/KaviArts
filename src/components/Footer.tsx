        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <a
                ...
                className="flex flex-col items-center text-muted-foreground hover:text-primary transition"
              >
                <PinterestIcon className="w-6 h-6 mb-1" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground mb-4">
              <li><a href="/search?query=nature&from=footer" className="hover:text-primary">Nature Wallpapers</a></li>
              <li><a href="/search?query=anime&from=footer" className="hover:text-primary">Anime Wallpapers</a></li>
              <li><a href="/search?query=aesthetic&from=footer" className="hover:text-primary">Aesthetic Ringtones</a></li>
              <li><a href="/search?query=cinematic&from=footer" className="hover:text-primary">Cinematic Videos</a></li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/app" className="hover:text-primary">Get Our App</a></li>
            </ul>
          </div>
        </div>
